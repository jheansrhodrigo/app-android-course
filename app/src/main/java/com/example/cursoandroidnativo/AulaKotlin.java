...
public class AulaKotlin extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aula_kotlin);

        final AulaEntidadeKotlin aula = (AulaEntidadeKotlin) getIntent().getSerializableExtra("aula");
        ...
        buttonConcluir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AulaKotlin.this, DeveloperGuidesKotlinActivity.class);
