...
import entities.AulaEntidadeKotlin;

public class DeveloperGuidesKotlinActivity extends AppCompatActivity {
    private Button buttonChooseTec;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_developer_guides_kotlin);

        buttonChooseTec = findViewById(R.id.buttonTrocarTecnologia);
        buttonChooseTec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeveloperGuidesKotlinActivity.this, ChooseLanguageActivity.class);
    ...
    private LinearLayout getLinearLayoutAula(){
        String filter = "";
        List<AulaEntidadeKotlin> lista = AulaEntidadeKotlin.buscaTodos(this, filter);
        Log.v("DB", "Items: "+String.valueOf(lista.size()));
        LinearLayout layout = new LinearLayout(this);

        for (final AulaEntidadeKotlin aula : lista) {
            ...
            tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    System.out.println("\nAcessar Aula\n");
                    Intent myIntent = new Intent(getBaseContext(), com.example.cursoandroidnativo.AulaKotlin.class);
